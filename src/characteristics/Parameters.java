...
public class Parameters {
  ...
  //---TEAM-B-PARAMETERS---//
  //-----------------------//
  public static final String teamBName = "CampFire";
  public static final String teamBMainBotBrainClassName = "algorithms.GunBot"; //class given by name; is supposed to extends robotsimulator.Brain
...
public static final String teamBSecondaryBotBrainClassName = "algorithms.ViperBot"; //class given by name; is supposed to extends robotsimulator.Brain
